...
public class AddAttribute extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Physical", "Mental", "Spiritual" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        AttributeDAO add = new AttributeDAO();
        String newAtt = jTextField1.getText();
        String newAbv = jTextField2.getText();
        String newType = jComboBox1.getSelectedItem().toString();
        System.out.println("Type is:  " + newType);
        Boolean added = add.addAttribute(newAtt, newAbv, newType);
        if (added) {
          jLabel6.setText("Attribute Added");
    } else {
            jLabel6.setText("Attriubte failed to add.");
            }
